...
session_start();  
 ...
 {  
  ...
  if(isset($_POST['register'])){
	...
	echo $sql1="INSERT INTO `tbl_login`( `email`, `username`,`password`, `status`, `role`) VALUES ('$email','$username','$password',1,1)";
			...
			$mid=$ar['id'];
			//echo $mid;
$sq="INSERT INTO `tbl_user`(`l_id`, `name`, `email`, `phone`,`city`, `gender`, `district_id`) VALUES ('$mid','$username','$email','$phone','$city','$gender','$district')";
$res1=mysqli_query($connect,$sq);

	     }
			 if($result1&&$res1)
			 {
echo "<script>if(confirm('Registration successful! Do you want to Login')){document.location.href='index.php#logd'}else{document.location.href='register.php'};</script>";
