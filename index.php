...
.dropdown:hover .dropbtn {
   ...
   <li><a href="#" data-nav-section="home">Home</a>
					...
					<div class="dropdown">
    <ul class="nav navbar-nav navbar-right">  
   <li><a href="#" data-nav-section="highlights">Highlights</a>
						</li></ul>
	</div>
   ...
   <a href="#"data-nav-section="Register">Register</a>
			...
			<div class="container">
				<div class="row r-pb">
					<div class="col-md-8 col-md-offset-2 text-center section-heading">
						<h2 class="fh5co-section-title animate-box">Highlight Videos</h2>
						<p class="fh5co-lead animate-box">Let's have a look on the highlight Videos</p>
					</div>
				</div>
				...
				<div class="row">
								...
								<?php
	  include 'dbcon.php';
	$result1=mysqli_query($connection,"SELECT `v_id`, `video_name`, `v_caption`, `s_id` FROM `tbl_video`");
...
<video class="video_player" id="player" width="100%" controls="controls" width="300" height="220" controls><source src="video/<?php echo $row['video_name'];?>" type="video/ogg"></video>
				</div>
			...
			<div class="container" >
				<div class="row r-pb">
					<div class="col-md-8 col-md-offset-2 text-center section-heading animate-box">
						<h2 class="fh5co-section-title">Login here</h2>
						<p class="fh5co-lead">Login if you are already a gotfocuz member(User/Studio)</p>
					</div>
				</div>
...
<section id="register">
     <div class="container" style="width:500px;" data-section="Register">  
          
                <h3 align="center">Signup to be a member</h3>  
                <br />  
                <form name="myform" method="post" action="reg_pro.php">  
                     <label>Enter Name</label>  
                     <input type="text" name="username" id="username" class="form-control" onChange="fn();" required/>  
                     <br />  
					 <label>Enter Email</label>  
                     <input type="email" name="email" id="em" class="form-control" onchange="return exist(this.value)"/>  
                     <label style="color:RED; font-size: 15px;" id="avail"></label>
					 <label style="color:RED; font-size: 15px;" id="pas"></label><br /> 
					 <label>Gender</label>   
                     <input type="radio" name="gender" value="male" id="gender" onchange="gender();" checked/>Male
...
?>
                     ...
                     <input type="text" name="phone" id="phone" class="form-control" onChange="mob();" />  
                     <br /> 
					 <label>Enter Password</label>  
                     <input type="password" name="password" id="pass" class="form-control" onChange="a();" />  
                     <br /> 
                     <label>Enter Confirm Password</label>  
                     <input type="password" name="conpas" id="conpas" class="form-control" required/>  
                     <br />  
                     <input type="submit" name="register" value="Register" class="btn btn-info"  />  
                     <br />  
                   
                </form>  
               <a href="studio/studio_signup.php">Click here to Signup as a Studio.</a>  
           </div> 
		   </section>
