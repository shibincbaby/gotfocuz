...
<div class="container">
  ...
  <div class="form-group">
      ...
      <textarea  class="form-control" id="address" placeholder="Address" name="address" value="<?php echo $row['s_name'];?>" onChange="adfn();" required></textarea>
    </div>
  <div class="form-group">
      <label for="phone">Mobile:</label>
      <input type="number" class="form-control" id="phone" placeholder="Mobile" name="phone" value="<?php echo $row['s_name'];?>" onChange="mob();" required>
    </div>
  <div class="form-group">
      <label for="email">Email:</label>
      <input type="email" class="form-control" id="email" placeholder="Email" name="email" value="<?php echo $row['s_name'];?>" onChange="efn();" required>
    </div>
  <div class="form-group">
